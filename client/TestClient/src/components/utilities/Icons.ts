/** 
    ...
    const d=require('./node_modules/lucide-static/font/info.json');
    const fs = require('fs');
    fs.writeFileSync('./src/components/Icons_Updated.ts', 'export type IconClassName =\n  ' + Object.values(d).map(v=>`| \"${v.className}\"`).join('\n  ') + ';')
*/

/**
    Generated from `node_modules\lucide-static\font\info.json@0.511.0`
*/
